...
import { BaseCommInterface, SendMessageArg, SendVoiceArg } from '../ChatPlantformInterface';
...
/**Telegram接口 */
export class TelegramApi extends CommApiBase implements BaseCommInterface{
    charname:string;
    token: string;
    proxyUrl?:string;
